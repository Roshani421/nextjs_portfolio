...
const Contact = () => {
  return (
    <section id='Contact' className='bg-[url(/contact/contact-bg.png)] py-28'>
      <div className='px-6 container flex flex-col justify-between py-12 text-lg md:flex-row'>
        <motion.div
        ...
        >
          <h1 className='text-[40px] font-bold uppercase leading-[3rem]'>
            let&apos;s work <br /> <span className='underline'>together</span>
          </h1>
        </motion.div>
        <motion.form
        ...
        >
          ...
          ></textarea>
          <button className='w-48 mt-12 flex items-center justify-between gap-x-2 rounded-full bg-blue px-4 py-3 transition-all duration-300 hover:bg-lighted hover:text-secondary'>
